...
/* Commented out: Manually defined Security Group (that is replaced by module defined security group above)

resource "aws_security_group" "blog" {
  name = "blog"
  description = "Allow http/https in. Allow evething out"
